...
export const AssetList: React.FC<AssetListProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* DESKTOP / TABLET VERSION (sm:flex): Category Tabs (Single-Row Horizontal Scroll) */}
      <div className="hidden sm:flex items-center gap-2 overflow-x-auto py-1 no-scrollbar w-full max-w-full shrink-0">
        {categories.map((cat) => {
          const Icon = cat.icon;
          const isActive = selectedCategory === cat.id;
          return (
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative w-full h-40 bg-stone-100 rounded-xl overflow-hidden border border-stone-200 flex items-center justify-center group/photo">
                    ...
                    <div className="absolute top-2 left-2 flex items-center gap-1.5">
                      ...
                      <span className={`px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded-md border ${statusConfig.badgeClass}`}>
                        {statusConfig.label}
                      </span>
                    </div>

                    {/* Infrastructure Sync State Indicator */}
                    <div className="absolute top-2 right-2 flex items-center gap-1 bg-white/90 backdrop-blur-md px-2 py-0.5 rounded-full border border-stone-200 shadow-2xs">
                ...
                <div className="flex items-center gap-3.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`px-1.5 py-0.2 text-[9px] font-bold uppercase rounded border ${statusConfig.badgeClass}`}>
                        {statusConfig.label}
                      </span>
